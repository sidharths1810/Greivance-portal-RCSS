...
if ($conn instanceof mysqli) {
    try {
        $sql = "SELECT  u.username, s.name, s.email, s.profile_image
                FROM users u
...
<head>
  ...
  <meta name="description" content="Student grievance dashboard — Rajagiri College Grievance Redressal Portal." />
    ...
    <aside id="studentSidebar"
      ...
      <nav class="flex flex-col space-y-2 flex-1 w-full px-3">
        ...
        <a href="dashboard.php"
           class="group relative w-full h-12 rounded-xl bg-hot ring-2 ring-sun/60
                  flex items-center text-white nav-icon-link px-3">
          ...
          <span class="sidebar-tooltip absolute left-full ml-3 hidden group-hover:block whitespace-nowrap
                       bg-ink text-white text-xs font-semibold px-3 py-1.5 rounded-lg shadow-lg z-50 border border-white/10">
            Dashboard
          </span>
        </a>
      ...
      <a href="#" data-logout-trigger="1" id="sidebarLogoutBtn"
         class="group relative w-full h-12 rounded-xl bg-white/10 hover:bg-hot
                flex items-center text-white nav-icon-link mx-3 px-3"
        ...
        <span class="sidebar-tooltip absolute left-full ml-3 hidden group-hover:block whitespace-nowrap
                     bg-hot text-white text-xs font-semibold px-3 py-1.5 rounded-lg shadow-lg z-50">
          Logout
        </span>
      </a>
    </aside>
      ...
      <header class="sticky top-0 z-30 bg-white border-b border-slate-200">
        ...
        <div class="flex items-center justify-between px-4 sm:px-6 py-3 md:py-4">
          ...
          <div class="relative" id="student-dropdown-container">
            <button id="student-dropdown-btn" type="button" aria-haspopup="true" aria-expanded="false" aria-controls="student-dropdown-menu"
            ...
            <div id="student-dropdown-menu" class="hidden absolute right-0 z-50 mt-3 w-72 rounded-xl border-2 border-ink bg-white p-2 shadow-[6px_6px_0_#FFC93C]" role="menu">
              ...
              <div class="flex items-center gap-2">
                ...
                <span id="currentPageBadge"
                      class="inline-flex items-center justify-center w-9 h-9 rounded-lg
                             bg-hot border-2 border-ink text-white text-sm font-bold shadow-[2px_2px_0_#FFC93C]">
                  1
                </span>
          ...
          <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              ...
              <div>
                ...
                <ul class="space-y-2 text-xs text-slate-200">
                  <li class="flex items-center gap-2"><i data-lucide="mail" class="w-3.5 h-3.5 text-sun"></i><a href="mailto:student.grievance@rajagiri.edu" class="rounded transition-colors hover:text-white hover:underline underline-offset-4">student.grievance@rajagiri.edu</a></li>
