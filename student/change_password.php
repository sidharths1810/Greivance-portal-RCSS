...
if ($conn instanceof mysqli) {
    try {
        ...
        error_log('[Student Change Password Profile] ' . $ex->getMessage());
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($formErrors) && $conn !== null) {
        try {
            ...
            error_log('[Student Change Password] ' . $ex->getMessage());
...
<head>
  ...
  <title>Change Password — Student | Rajagiri College Grievance Portal</title>
